    ...
    <div className="dashboard-parent">
      <div className="dashboard-parent-main">
        ...
        <Card className="parent-child-card">
          ...
          <p>
            <strong>ФИО:</strong> {child?.fullName ?? "—"}
          </p>
          <p>
          ...
          <p>
            ...
            {child?.subjectIds?.length
              ? child.subjectIds.map((id) => SUBJECT_NAMES[id] ?? id).join(", ")
              : "—"}
          </p>
        </Card>
        ...
        <Card className="parent-stats-card">
          <h2>Статистика</h2>
          <p>
            <strong>Пройдено уроков:</strong> {isLoading ? "…" : lessons.length}
          </p>
          <p>
            <strong>Заработано баллов:</strong> {isLoading ? "…" : points}
          </p>
        </Card>
